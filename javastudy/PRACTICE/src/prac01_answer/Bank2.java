...
public class Bank2 {
	...
	public Bank2(String accNo, long balance) {	// new Bank("1234, 50000)
		this.accNo = accNo;
	...
	// # 이체(출금도 되고, 입금도 되어야함)
	public void transfer(Bank2 other, long money) {
...
//		other.deposit(withdrawl(money)); 
	...
	public static void main(String[] args) {
		...
		Bank2 me = new Bank2("1234", 50000);
		Bank2 mom = new Bank2("4567", 100000);
